              ...
              <div className="space-y-12">
                <div className="space-y-5 sm:space-y-4 md:max-w-xl lg:max-w-3xl xl:max-w-none">
                  ...
                  <p className="text-xl text-gray-300">
                    Ornare sagittis, suspendisse in hendrerit quis. Sed dui aliquet lectus sit pretium ege
                  </p>
                  <SearchBox onSearchChange={this.props.onSearchChange} placeholder='Search characters' />
                </div>
